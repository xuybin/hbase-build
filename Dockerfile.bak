...
RUN HBASE_BRANCH=1.4 \
 ...
 && unzip -x -q /root/hbase-branch-$HBASE_BRANCH.zip /root/ && cd /root/hbase-branch-$HBASE_BRANCH && mvn -DskipTests -Dhadoop-two.version=$HADOOP_VER package assembly:single \
